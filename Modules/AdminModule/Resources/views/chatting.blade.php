...
@push('css_or_js')
    {{-- <link rel="stylesheet" href="{{ asset('public/assets/admin-module/css/lightbox.css') }}" /> --}}
...
@section('content')
    <div class="content container-fluid">
        ...
        {{-- <span id="chatting-post-url" data-url="#"></span> --}}
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function onSuccess(response) {
                ...
                driverList('{{ route('admin.search-drivers') }}');
