        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img width="80" height="80" src="{{ asset('public/assets/admin-module/img/modal/mark.png') }}"
                     alt="">
                <h5 class="title-color mt-4 mb-2 " id="vehicleRequestApprovalTitle"> {{ translate('Are you sure you want to approve the vehicle') }}?
                </h5>
                ...
                <form id="vehicleRequestApprovalForm" action="" method="POST">
                    ...
                    <div class="d-flex justify-content-center gap-3 mt-5">
                        <button type="button"
                                class="btn btn--cancel min-w-120 d-flex justify-content-center" data-bs-dismiss="modal">{{ translate('cancel') }}</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="vehicleRequestDenyForm" action="" method="POST">
                    ...
                    @method('PUT')
                    <div class="mt-4">
                        <label for="" class="form-label"> {{ translate('Deny Note') }} <span class="text-danger">*</span></label>
                        <div class="character-count d-flex flex-column">
                            <textarea class="form-control character-count-field" maxlength="150" data-max-character="150" id=""
                                      name="deny_note" rows="4" placeholder="Type a deny note for your customer" required></textarea>
