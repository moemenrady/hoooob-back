            ...
            <form action="{{ route('admin.employee.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card mt-3">
                    <div class="card-header">
                        ...
                        <div class="fs-12 title-color"> {{ translate('Setup the necessary information and include the documents of the employee') }}</div>
                    </div>
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-lg-4 mb-4 mb-lg-0">
                                <div>
                                    ...
                                    <div class="fs-12 title-color"> {{ translate('Here you can set the primary information of the employee to ensure the basic details.') }}</div>
                                </div>
                            </div>
                            <div class="col-lg-8">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="fs-12 title-color mb-4"> {{ translate("Define the employee's role, assign tasks, and set access levels accordingly.") }}</div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="fs-12 mb-3 title-color"> {{ translate('Here you can setup the details that will be helpful to login to the panel') }}</div>
                ...
                <div class="d-flex justify-content-end gap-2 py-4">
                    <button type="button" class="btn btn-light fw-semibold h-40px min-w-100px justify-content-center">{{ translate('discard') }}</button>
                    <button class="btn btn-primary h-40px fw-semibold min-w-100px justify-content-center" type="submit">{{ translate('save') }}</button>
                </div>
            </form>
        </div>
    </div>
...
@push('script')
    ...
    <script>
        ...
        $("#multi_image_picker").spartanMultiImagePicker({
            ...
            maxCount: 5,
            rowHeight: '130px',
            groupClassName: 'upload-file__img upload-file__img_banner bg-white mb-0',
            placeholderImage: {
                image: "{{ asset('public/assets/admin-module/img/document-upload.png') }}",
                width: '34px',
            },
            dropFileLabel: `
                <h6 id="dropAreaLabel" class="mt-2 fw-semibold drop-area-label">
                    <span class="text-info">{{ translate('Click to upload') }}</span>
                    <br>
                    {{ translate('or drag and drop') }}
                </h6>`,
