...
use Modules\ZoneManagement\Http\Controllers\Web\New\Admin\CarpoolStationController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'admin'], function () {
    ...
    Route::group(['prefix' => 'carpool-station', 'as' => 'carpool-stations.'], function () {
        Route::controller(CarpoolStationController::class)->group(function () {
            Route::get('/index', 'index')->name('index'); // تم تغييرها لـ index
            Route::post('/store', 'store')->name('store');
            Route::get('/edit/{id}', 'edit')->name('edit');
            Route::put('/update/{id}', 'update')->name('update');
            Route::delete('/delete/{id}', 'destroy')->name('delete');
