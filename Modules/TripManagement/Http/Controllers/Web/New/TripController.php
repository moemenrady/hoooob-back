...
//        dd($attributes);
        $trips = $this->tripRequestService->getBy(criteria: ['customer_id' => $request->id], searchCriteria: $attributes, relations: ['tripStatus', 'customer', 'driver', 'fee'], orderBy: ['created_at' => 'desc']);
